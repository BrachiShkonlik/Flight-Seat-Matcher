...
seat_assigned_vars = pulp.LpVariable.dicts("SeatAssigned", (s.seat_number for s in seats), cat="Binary")
...
# Constraint 3: Ensure that seat assignment variables reflect actual assignments
for seat in seats:
    prob += pulp.lpSum(passenger_seat_vars[p.name, seat.seat_number] for p in passengers) == seat_assigned_vars[seat.seat_number]

# Define objective function
# Maximize the total satisfaction of passengers based on their preferences and seat availability
