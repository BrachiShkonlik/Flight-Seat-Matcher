...
def print_searchcv_result(self, classifier_model):
    ...
    try:
        ...
        for mean, standard_deviation, parameter in zip(means, standard_deviations,
                                                       classifier_model.cv_results_["params"]):
...
def print_exception_message(self, message_orientation="horizontal"):
    ...
    try:
        ...
        if (message_orientation == "horizontal"):
            print("An error occurred:{};{};{};{};{};{};{}".format(time_stamp, file_name, procedure_name, error_message,
...
def main(image_path_name):
    ...
    try:
        ...
        image_1d_nparray = image_array_flatten_class.image_flatten_pixel_nparray_opencv(image_path_name,
                                                                                        nparray_dimension,
                                                                                        image_resize_factor)
