...
namespace GeneticSharp
{
    ...
    public abstract class ChromosomeBase : IChromosome
    {
        ...
        public void ReplaceGene(int index, Gene gene)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(index), "There is no Gene on index {0} to be replaced.");
            }
        ...
        public void ReplaceGenes(int startIndex, Gene[] genes)
        {
            ...
            if (genes.Length > 0)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(nameof(startIndex), "There is no Gene on index {0} to be replaced.");
                }
